...
const headCells: HeadCell[] = [
  { id: 'name', numeric: false, disablePadding: true, label: 'Animal type' },
  { id: 'calories', numeric: true, disablePadding: false, label: 'Age' },
  { id: 'fat', numeric: true, disablePadding: false, label: 'Weight (kg)' },
  { id: 'carbs', numeric: true, disablePadding: false, label: 'Color' },
